...
$ns duplex-link $n0 $n1 1Mb 20ms DropTail #2-3
$ns duplex-link $n1 $n2 2Mb 30ms DropTail #1-2
$ns duplex-link $n1 $n3 2Mb 10ms DropTail #1-3
# $ns duplex-link $n2 $n3 2Mb 50ms DropTail #0-1
# $ns duplex-link $n3 $n4 4Mb 20ms DropTail #4-3
$ns duplex-link $n4 $n0 2Mb 30ms DropTail #4-0

#set queue size of link
$ns queue-limit $n0 $n1 10
$ns queue-limit $n0 $n4 6
